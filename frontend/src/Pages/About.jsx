    ...
    const teamMembers = [
        {
            name: 'Santusht Matra',
            role: 'NULL',
            bio: 'Santusht is an experienced project manager with a knack for keeping teams organized and motivated. She ensures all aspects of the project are delivered on time and within scope.',
        ...
        },
        {
            name: 'Saee Nalawde',
            role: 'NULL',
            bio: 'Saee is a strategic marketer specializing in digital campaigns and branding. He ensures the project reaches the right audience effectively.',
            image: 'https://via.placeholder.com/150',
        },
    ];
